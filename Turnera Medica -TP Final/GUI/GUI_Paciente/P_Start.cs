...
namespace Turnera_Medica__TP_Final.GUI.GUI_Paciente
{
    public partial class P_Start : Form
    {
        ...
        {
            P_Shifts p_shifts_form = new P_Shifts();
        ...
        {
            P_MyInfo p_myinfo_form = new P_MyInfo();
        ...
        {
            P_SpecificShift p_specificshift_form = new P_SpecificShift();
        ...
        {
            P_AvailableShifts p_availableshifts_form = new P_AvailableShifts();
